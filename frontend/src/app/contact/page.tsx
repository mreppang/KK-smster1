          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-gray-900/50 border border-gray-800/50">
              ...
              <div className="flex gap-3">
                {[
                  { label: "Instagram", link: "https://www.instagram.com/mreppang/" },
                  { label: "Github", link: "https://github.com/mreppang" },
                  { label: "Linkedin", link: "https://www.linkedin.com/in/m-revan-adi-suntama-45a5b1426/" },
                ].map((social) => (
                  <a
                    key={social.label}
                    href={social.link}
                    ...
                    aria-label={`Buka ${social.label} (terbuka di tab baru)`}
                    title={`Buka ${social.label}`}
